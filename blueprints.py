...
@api.route("/")
def all():
    status_json = status_json_or_404()
...
def info(field=None):
    status_json = status_json_or_404(endpoint="info",
                                     field=field)
...
def programstatus(field=None):
    status_json = status_json_or_404(endpoint="programstatus",
                                     field=field)
...
def hoststatus(host_name=None, field=None):
    status_json = status_json_or_404(endpoint="hoststatus",
                                     host_name=host_name,
                                     field=field)
...
def servicestatus(host_name=None, service_description=None, field=None):
    status_json = status_json_or_404(endpoint="servicestatus",
                                     host_name=host_name,
...
def contactstatus(contact_name=None, field=None):
    status_json = status_json_or_404(endpoint="contactstatus",
...
def hostcomment(host_name=None, field=None):
    status_json = status_json_or_404(endpoint="hostcomment",
                                     host_name=host_name,
                                     field=field)
